...
require("../../node_modules/sheetify/insert-css")(":root, :root body {\n  padding: 0;\n  margin: 0;\n  background-color: black;\n}\n");for(var h=require("virtual-dom/h"),comic=require("./comic"),className="_c8383662",comics=[],i=1;20>=i;i++)comics.push(comic(i));module.exports=function(){return h("div",{className:className},comics)};
